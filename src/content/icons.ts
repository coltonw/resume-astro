...
const SVG_COMPONENTS: Record<string, AstroComponentFactory> = {
  Alexa, Auth0, Aws, Babel, Bevy, Biome, Bootstrap, Bower, Bulma, CSharp,
  CircleCI, Cloudflare, Elixir, Express, Flow, Gatsby, Golang, GoogleSheets,
  Graphql, Gulp, Heroku, Hono, Koa, Less, Mocha, MongoDB, NextJs, Nivo,
  NodeJs, Npm, Phoenix, Playwright, Python, Ramda, React, Rust, ScalaJs,
  Serverless, Sharp, Svelte, TailwindCss, TravisCI, Typescript, Unity,
  Vercel, Vite, WebAssembly, Webpack,
};
