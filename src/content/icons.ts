...
const SVG_COMPONENTS: Record<string, AstroComponentFactory> = {
  Alexa, Astro, Auth0, Aws, Babel, Bevy, Biome, Bootstrap, Bower, Bulma,
  CSharp, CircleCI, Claude, Cloudflare, Deno, DenoDeploy, Elixir, Express,
  Flow, Fresh, Gatsby, Golang, GoogleSheets, Graphql, Gulp, Heroku, Hono,
  Jimp, Koa, LanceDB, Less, Mocha, MongoDB, NextJs, Nivo, NodeJs, Npm,
  Ollama, Phoenix, Playwright, PuzzleScript, Python, Ramda, React, Rust,
  ScalaJs, Serverless, Sharp, Svelte, TailwindCss, TravisCI, Typescript,
  Unity, Vercel, Vite, WebAssembly, Webpack,
};
