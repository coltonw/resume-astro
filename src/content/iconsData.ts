...
export const ICON_META = {
  ...
  astro: { title: 'Astro', href: 'https://astro.build/', svg: 'Astro', extraClass: 'text-stone-800' },
  claude: { title: 'Claude', href: 'https://claude.ai/', svg: 'Claude', extraClass: 'text-orange-600' },
  ...
  deno: { title: 'Deno', href: 'https://deno.com/', svg: 'Deno', extraClass: 'text-stone-800' },
  denoDeploy: { title: 'Deno Deploy', href: 'https://deno.com/deploy', svg: 'DenoDeploy', extraClass: 'text-stone-800' },
  ...
  fresh: { title: 'Deno Fresh', href: 'https://fresh.deno.dev/', svg: 'Fresh', extraClass: 'text-yellow-500' },
  ...
  jimp: { title: 'Jimp', href: 'https://github.com/jimp-dev/jimp', svg: 'Jimp' },
  koa: { title: 'Koa', href: 'https://koajs.com/', svg: 'Koa' },
  lancedb: { title: 'LanceDB', href: 'https://lancedb.com/', svg: 'LanceDB', extraClass: 'text-blue-700' },
  ...
  ollama: { title: 'Ollama', href: 'https://ollama.com/', svg: 'Ollama', extraClass: 'text-stone-800' },
  ...
  puzzlescript: { title: 'PuzzleScript', href: 'https://www.puzzlescript.net/', svg: 'PuzzleScript' },
