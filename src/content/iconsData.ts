...
export const ICON_META = {
  ...
  astro: {
    ...
    svg: "Astro",
    extraClass: "text-stone-800",
  },
  claude: {
    title: "Claude",
    href: "https://claude.ai/",
    svg: "Claude",
    extraClass: "text-orange-600",
  },
  auth0: {
    title: "Auth0",
